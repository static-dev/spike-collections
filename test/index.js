...
test.cb('pagination', t => {
  ...
  spikeCompile(t, root, locals, opts, () => {
    ...
    t.is(
      index.trim(),
      '<all-posts>{"posts":[{"dingle":"snargle","_path":"posts/bar.html","_collection":"posts","permalink":"extra!"},{"wow":"amaze","_path":"posts/foo.html","_collection":"posts","permalink":"extra!"}]}</all-posts>'
    )
...
test.cb('collection without pagination', t => {
  ...
  spikeCompile(t, root, locals, opts, () => {
    ...
    t.is(
      index,
      '<all-posts>{"posts":[{"dingle":"snargle","_path":"posts/bar.html","_collection":"posts"},{"wow":"amaze","_path":"posts/foo.html","_collection":"posts"}]}</all-posts>\n'
    )
